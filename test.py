...
if __name__ == '__main__':
    if(len(sys.argv) != 3):
        ...
        print('python test.py config19/test_all_class.txt /gpfs/scratch/bz957/brats/data/langone/post/post_5cases_t1ce2t1_f2t2')
        exit()
    ...
    for folder in os.listdir(data_file):
        if not folder.startswith('.'):
            file = open('/gpfs/scratch/bz957/brats/config19/test_names_temp.txt', 'w')
            print(f'data/langone/pre/nifti/GBM_nii/{basename}\n')
            file.write(f'data/langone/pre/nifti/GBM_nii/{basename}\n')
            file.close()
            test(config_file)
            break
